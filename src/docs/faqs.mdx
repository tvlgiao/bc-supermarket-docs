...
(function($) {
    $('<style></style>').html(''
        ...
        + '.navUser-item--search .navUser-action { font-size: 22px; padding: 0; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; margin-right: 10px; }'
