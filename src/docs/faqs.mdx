...
(function($) {
    ...
    function main() {
        $('.productView-bulkPricing-table').each(function(i, table) {
            ...
            var $priceClone = $table.closest('.productView').find('._data-product-price-without-tax._clone');
            if ($priceClone.length === 0) {
                $priceClone = $price.clone().insertAfter($price).addClass('_data-product-price-without-tax _clone').show();
            }
            ...
            var showBulkOptions = function() {
                $table.closest('.productView').find('.form-field--bulk').remove();
                ...
                $qty.closest('.form-field--increments').before($field);
            ...
            mo = new MutationObserver(debounce(function() {
                updatePrice();
                updateBulkPrice();
                showBulkOptions();
            }, 10));
    ...
    main();
    (new MutationObserver(debounce(main, 200))).observe(document.body, { childList: true, subtree: true });
    var style = document.createElement('style');
